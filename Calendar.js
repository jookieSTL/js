   ...
   months:
    {
      ...
      francais:["janvier", "f�vrier", "mars", "avril", "mai", "juin", "juillet", "ao�t", "septembre", "octobre", "novembre", "d�cembre"],
      deutsch:["Januar", "Februar", "M�rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"],
    ...
    days:
    {
      ...
      espanol:["Domingo",  "Lunes", "Martes", "Mi�rcoles", "Jueves", "Viernes", "S�bado"]
    },
